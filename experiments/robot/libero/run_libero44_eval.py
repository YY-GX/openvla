...
class GenerateConfig:
    ...
    pretrained_checkpoint: Union[str, Path] = "runs/1.0.0/openvla-7b+libero44+b8+lr-0.0005+lora-r32+dropout-0.0--image_aug"     # Pretrained checkpoint path
...
def eval_libero(cfg: GenerateConfig) -> None:
    ...
    for task_id in tqdm.tqdm(range(num_tasks_in_suite)):
        ...
        for episode_idx in tqdm.tqdm(range(cfg.num_trials_per_task)):
            ...
            elif cfg.task_suite_name == "single_step":
                max_steps = 400  # longest training demo has 373 steps
        ...
        np.save(os.path.join(cfg.local_log_dir, f"tasks_success_list_{cfg.task_suite_name}.npy"), np.array(tasks_success_list))
